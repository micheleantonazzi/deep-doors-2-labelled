...
from deep_doors_2.door_sample import *

# Set the datasets' locations
dataset_load_path = ''
dataset_save_path = ''
folder_name = ''
...
class_index = 0
img_absolute_counts = folder_manager_load.get_samples_absolute_counts(label=1)[:]
...
def next_img_index():
    ...
    img_objects = [(label, *box) for label, *box in sample.get_bounding_boxes()]
...
while True:
    ...
    cv2.putText(tmp_img, f'Image {img_index}', (5, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2, cv2.LINE_AA)
